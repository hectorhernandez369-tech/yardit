...
function LayoutContent({ children, user, setUser }) {
  ...
  const isHomeMobileChromeHidden = location.pathname === "/" || location.pathname === createPageUrl("Home");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F3E6CF] overflow-x-hidden max-w-[100vw]">
      ...
      <header className={`${isHomeMobileChromeHidden ? "hidden sm:block" : ""} bg-[#5DADA5] border-b-2 border-[#2C4F4E] sticky top-0 z-50 shadow-md`}>
      ...
      <footer className={`${isHomeMobileChromeHidden ? "hidden sm:block" : ""} bg-[#5DADA5] border-t-2 border-[#2C4F4E] py-3`}>
