...
export default function HalloweenSpotPopupCard({ listing }) {
  const fullIcon = listing.custom_icon_url || HALLOWEEN_ICON_ASSETS[listing.halloween_spot_type || listing.halloween_icon_key || listing.icon_key || "halloween_decorations"] || HALLOWEEN_ICON_ASSETS.halloween_decorations;
