            ...
            <div key={section.title} className="bg-white rounded-lg border-2 border-[#5DADA5] p-4 sm:p-6">
              ...
              <div className="space-y-3">
                {section.items.map(item => (
                  <button key={item.id} onClick={() => toggleItem(item.id)} className="w-full flex items-start gap-3 p-3 rounded-lg hover:bg-[#F3E6CF] transition-colors text-left group">
