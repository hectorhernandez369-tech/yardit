      ...
      <DialogContent className="sm:max-w-md bg-[#F3E6CF] border-2 border-[#2C4F4E]">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-[#2C4F4E] text-center">
            {isFallback ? "Install Yardit" : "Install Yardit on iPhone"}
          </DialogTitle>
        </DialogHeader>
        <div className="space-y-3 text-[#2C4F4E] text-sm sm:text-base">
          {isFallback ? (
            <p>
              Install is not available yet on this browser.
              Try Chrome on Android, or use your browser menu to add Yardit to your home screen.
            </p>
          ) : (
            <>
