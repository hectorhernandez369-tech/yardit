...
import { Plus, Edit, Pause, Play, Copy, Eye, Trash2, BarChart2 } from "lucide-react";
            ...
            <tbody className="divide-y divide-slate-100">
              {filtered.map((promo) => (
                <tr key={promo.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-3 py-2 text-xs">{formatCoverage(promo)}</td>
            ...
            <Card key={promo.id} className="border border-slate-200">
              <CardContent className="p-4 space-y-3">
                ...
                <div className="text-xs text-slate-600 space-y-1">
                  ...
                  <p>Coverage: {formatCoverage(promo)}</p>
