    ...
    <Dialog open={open} onOpenChange={(nextOpen) => { if (!nextOpen) onClose(); }}>
      <DialogContent className="max-w-lg max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="space-y-4 text-sm text-slate-600 leading-relaxed overflow-y-auto min-h-0 pr-1">
          ...
          <p>
            Neighborhood Sales work best when the host invites neighbors in person. Yardit is the tool to organize, map, and manage the sale — it does not magically create participants.
          </p>
          <p>
            Talk to neighbors, hand out links or cards, and encourage them to join.
          </p>
        ...
        <DialogFooter className="shrink-0 pt-4">
          <Button onClick={onContinue} disabled={!acknowledged} className="bg-[#006168] hover:bg-[#004d52] text-white">
