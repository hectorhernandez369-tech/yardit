...
export const ORGANIZER_TYPE_CONFIG = {
  ...
  league: { label: "League Organizer", shortLabel: "League", icon: Trophy, route: "/LeagueTeamDashboard", createPath: "/SportsAccountSignup?organizer=league", badgeClass: "bg-blue-100 text-blue-800 border-blue-200 hover:bg-blue-100", iconClass: "text-blue-600" },
  team: { label: "Team Organizer", shortLabel: "Team", icon: Users, route: "/TeamDashboard", createPath: "/SportsAccountSignup?organizer=team", badgeClass: "bg-green-100 text-green-800 border-green-200 hover:bg-green-100", iconClass: "text-green-600" },
  league_team: { label: "League Organizer", shortLabel: "League", icon: Trophy, route: "/LeagueTeamDashboard", createPath: "/SportsAccountSignup?organizer=league", badgeClass: "bg-blue-100 text-blue-800 border-blue-200 hover:bg-blue-100", iconClass: "text-blue-600" },
