...
import OrganizerLeagueScoreboard from "@/components/league/scoreboard/OrganizerLeagueScoreboard";

const today = new Date().toISOString().slice(0, 10);

function MemberLeagueScoreboard({ account, user, games = [], assignments = [], memberships = [], isOwner = false, onRefresh }) {
...
export default function LeagueScoreboard(props) {
  return props.isOwner ? <OrganizerLeagueScoreboard account={props.account} games={props.games} onRefresh={props.onRefresh} /> : <MemberLeagueScoreboard {...props} />;
}