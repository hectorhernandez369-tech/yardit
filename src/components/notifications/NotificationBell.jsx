  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button variant="ghost" size="icon" className="yardit-nav-alert-button relative text-white hover:bg-white/20 h-12 w-12 touch-manipulation transition-all duration-200">
