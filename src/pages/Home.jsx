              ...
              return (
                <Marker
                  ...
                  <Popup maxWidth={340} minWidth={260} autoPan={true} autoPanPaddingTopLeft={[10, 10]} autoPanPaddingBottomRight={[10, 10]} className="leaflet-popup-transparent">
                         <div className="flex flex-col rounded-xl overflow-hidden backdrop-blur-md border border-white/30 shadow-lg opacity-100 bg-white/10" style={{ maxWidth: "min(90vw, 320px)", maxHeight: "70vh" }}>
