...
export default function HomePage() {
  ...
  return (
    <div className="h-[calc(100vh-140px)] flex flex-col">
      ...
      <div className="bg-white border-b border-slate-200 px-3 py-2 z-[100] flex-shrink-0 flex flex-col sm:flex-row items-center gap-2">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto shrink-0 justify-between sm:justify-end">
          ...
          <Button 
            ...
            className="h-9 w-9 shrink-0 border-slate-200 text-slate-500 bg-white hover:bg-slate-50"
          >
