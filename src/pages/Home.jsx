              ...
              return (
                <Marker
                  ...
                  <Popup maxWidth={340} minWidth={260} autoPan={true} autoPanPaddingTopLeft={[10, 10]} autoPanPaddingBottomRight={[10, 10]} className="leaflet-popup-transparent">
                         <div className="flex flex-col gap-1.5 bg-transparent" style={{ maxWidth: "min(90vw, 300px)", maxHeight: "55vh" }}>
                          ...
                          <Badge className="text-[9px] px-1.5 py-0 h-4 min-h-0 bg-blue-600">Stop #{routeIndex + 1}</Badge>
                            ...
                            <h3 className="inline-block rounded-lg border border-white/40 bg-white/10 px-2 py-1 font-bold text-base leading-tight text-slate-950 backdrop-blur-md shadow-sm">{getListingPrimaryText(listing)}</h3>
                        ...
                        <>
                          ...
                          <p className="rounded-lg border border-white/40 bg-white/10 px-2 py-1.5 text-xs text-slate-700 leading-relaxed backdrop-blur-md shadow-sm">{getListingDescriptionText(listing)}</p>
                          }
                                <div className="space-y-1 rounded-lg border border-white/40 bg-white/10 p-1.5 text-[11px] text-slate-700 backdrop-blur-md shadow-sm">
