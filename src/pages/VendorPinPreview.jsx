...
function createPreviewIcon({ pin, account, animation }) {
  ...
  const html = image
    ? `<div style='position:relative;width:46px;height:54px;animation:${animationCss};opacity:0.85;'><img src='${image}' alt='Truck logo' style='width:46px;height:46px;object-fit:contain;filter:drop-shadow(0 4px 8px rgba(0,0,0,.32));'/><div style='position:absolute;left:50%;bottom:0;width:0;height:0;transform:translateX(-50%);border-left:6px solid transparent;border-right:6px solid transparent;border-top:10px solid #2C4F4E;filter:drop-shadow(0 3px 3px rgba(0,0,0,.24));opacity:0.85;'></div></div>`
    : `<div style='width:46px;height:46px;display:flex;align-items:center;justify-content:center;animation:${animationCss};opacity:0.85;'><div style='width:32px;height:32px;border-radius:50% 50% 50% 0;background:#F4A849;border:3px solid #2C4F4E;box-shadow:0 4px 12px rgba(0,0,0,.32);transform:rotate(-45deg);'><div style='width:10px;height:10px;border-radius:9999px;background:#2C4F4E;margin:8px auto 0;'></div></div></div>`;
