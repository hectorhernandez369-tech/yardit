  ...
  return (
    <div className="min-h-screen bg-[#F3E6CF]">
      ...
      <div className="max-w-md mx-auto p-4 py-6">
        ...
        {state === "duplicate_token" && (
          <div className="text-center py-12">
            <XCircle className="w-16 h-16 text-amber-500 mx-auto mb-4" />
            <h2 className="text-xl font-bold text-gray-700 mb-2">QR Code Needs Refresh</h2>
            <p className="text-gray-500 mb-6">This QR code could not be safely matched to one listing. Please ask Yardit to generate a fresh QR code.</p>
            <Button onClick={() => navigate(createPageUrl("Home"))} variant="outline">Go Home</Button>
          </div>
        )}
        ...
        {state === "duplicate_token" && (
          <div className="text-center py-12">
            <XCircle className="w-16 h-16 text-red-400 mx-auto mb-4" />
            <h2 className="text-xl font-bold text-gray-700 mb-2">QR Code Issue</h2>
            <p className="text-gray-500 mb-6">This QR code needs to be regenerated by Yardit support.</p>
            <Button onClick={() => navigate(createPageUrl("Home"))} variant="outline">Go Home</Button>
          </div>
        )}
        {state === "listing_missing" && (
          <div className="text-center py-12">
            <XCircle className="w-16 h-16 text-gray-400 mx-auto mb-4" />
            <h2 className="text-xl font-bold text-gray-700 mb-2">Listing Not Found</h2>
            <p className="text-gray-500 mb-6">The QR code exists, but the listing it points to could not be loaded.</p>
            <Button onClick={() => navigate(createPageUrl("Home"))} variant="outline">Go Home</Button>
          </div>
        )}
