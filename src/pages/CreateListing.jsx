...
export default function CreateListingPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    halloween_candy_available: false,
    halloween_candy_schedule_mode: "",
    halloween_candy_start_date: "",
    halloween_candy_end_date: "",
    halloween_candy_start_time: "",
    halloween_candy_end_time: "",
    halloween_candy_custom_time: false,
    halloween_walkthrough: false,
    halloween_lights: false,
    halloween_sound: false,
    halloween_jump_scares: false,
  ...
  const handleSubmit = async ({ userInitiated = false } = {}) => {
    ...
    if (formData.listingType === "halloween_spot") {
      ...
      await base44.entities.Location.create({
        ...
        halloween_candy_schedule_mode: formData.halloween_candy_schedule_mode || "",
        halloween_candy_start_date: formData.halloween_candy_start_date || "",
        halloween_candy_end_date: formData.halloween_candy_end_date || formData.halloween_candy_start_date || "",
        halloween_candy_start_time: formData.halloween_candy_start_time || "",
        halloween_candy_end_time: formData.halloween_candy_end_time || "",
        ...
        halloween_jump_scares: formData.halloween_jump_scares === true,
        halloween_suggested_age: formData.halloween_suggested_age || "",
        halloween_host_name: formData.halloween_host_name || "",
