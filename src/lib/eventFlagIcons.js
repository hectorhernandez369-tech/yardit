export const EVENT_FLAG_ICONS = [
  ...
  // Yardit custom Halloween icon family.
  // Keep the legacy "haunted" key so existing saved flags automatically upgrade
  // from the old ghost emoji to the new Yardit Haunted House artwork.
