...
export function normalizeUser(user) {
  ...
  normalized.primary_address = normalized.primary_address || data.primary_address || data.formatted_address || data.display_address || data.address || normalized.address || "";
